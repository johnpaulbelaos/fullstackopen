...
sequenceDiagram
    ...
    Note right of browser: The browser submits the user input to the server
...
sequenceDiagram
    ...
    Note right of browser: The notes are rerendered with the new note using the JS file fetched earlier
```
